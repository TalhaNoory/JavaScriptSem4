...
getDataSequental().then(data => console.log(data))
Problem is we are using .then() <-
*/

/* dont be fooled by this code!
const data = getDataSequental();
console.log(data)
*/
...
async function test() {
  try {
    const data_one = await getDataSequental();
//    const data_two = await getDataParallel();
